...
void Render_StudentCourse() 
{
    int x = 10, y = 3;
    goToXY(x,y++);
    cout << "   ______    _________   _____  _____   ______     ________   ____  _____   _________           ______     ___    _____  _____   _______      ______    ________";
    goToXY(x,y++);
    cout << " .' ____ \\  |  _   _  | |_   _||_   _| |_   _ `.  |_   __  | |_   \\|_   _| |  _   _  |        .' ___  |  .'   `. |_   _||_   _| |_   __ \\   .' ____ \\  |_   __  |";
    goToXY(x,y++);
    cout << " | (___ \\_| |_/ | | \\_|   | |    | |     | | `. \\   | |_ \\_|   |   \\ | |   |_/ | | \\_|       / .'   \\_| /  .-.  \\  | |    | |     | |__) |  | (___ \\_|   | |_ \\_|";
    goToXY(x,y++);
    cout << "  _.____`.      | |       | '    ' |     | |  | |   |  _| _    | |\\ \\| |       | |           | |        | |   | |  | '    ' |     |  __ /    _.____`.    |  _| _  ";
    goToXY(x,y++);
    cout << " | \\____) |    _| |_       \\ \\__/ /     _| |_.' /  _| |__/ |  _| |_\\   |_     _| |_          \\ `.___.'  \\  `-'  /   \\ \\__/ /     _| |  \\ \\_ | \\____) |  _| |__/ |";
    goToXY(x,y++);
    cout << "  \\______.'   |_____|       `.__.'     |______.'  |________| |_____|\\____|   |_____|          `.____ .'  `.___.'     `.__.'     |____| |___| \\______.' |________|";
} 
