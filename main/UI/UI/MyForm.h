...
namespace UICourseManagementSystem {
	...
	//public:
	//	int role;
	//	Year* yearList = nullptr;
	//	Student* studentList = nullptr;
	//	Account* accountList = nullptr;
	...
	//	void getData(Year* year, Student* student, Account* account) {
	//		yearList = year;
	//		studentList = student;
	//		accountList = account;
	//	}
...
#pragma endregion
	...
	private: System::Void login_Click(System::Object^ sender, System::EventArgs^ e) {
		//string user = convertToString(username->Text);
		//string pass = convertToString(password->Text);
		...
		bool loggedIn = false;
		//while (cur && cur->next) {
		//	if (cur->username == convertToString(username->Text) && cur->password == convertToString(password->Text)) {
		//		loggedIn = true;
		//		break;
		//	}
		//	cur = cur->next;
		//}
		//curAccount = find_Account(accountList, convertToString(username->Text), convertToString(password->Text));
		if (username->Text == "admin" && password->Text == "admin") loggedIn = true;

		if (loggedIn) {
			//role = curAccount->role;
			String^ message = "Logged in successfully!!\nHello, " /*+ gcnew String(curAccount->lastName.c_str()) + " " + gcnew String(curAccount->firstName.c_str()) + */"!";
